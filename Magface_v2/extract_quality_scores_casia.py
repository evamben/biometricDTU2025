...
with open('Magface_v2/preprocessing_v1/Casia_Fasd/train/feat.list', 'r') as f:
    lines = f.readlines()
...
print(f"Low quality range: magnitude < {p33:.4f}")
print(f"Medium quality range: {p33:.4f} <= magnitude < {p66:.4f}")
print(f"High quality range: magnitude >= {p66:.4f}")
